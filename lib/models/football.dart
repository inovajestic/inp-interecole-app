...
class Football {
  ...
  Football.fromMap(Map<String, dynamic> map, {this.reference})
  ...
  Football.fromSnapshot(DocumentSnapshot snapshot)
      : this.fromMap(snapshot.data, reference: snapshot.reference);

  @override
  String toString() {
    return "Football<$journee:$categorie:$dateHeure:$enCours:$domicile:$scoreDomicile:$exterieur:$scoreExterieur:$statut:$temps:$terrain>";
  }
